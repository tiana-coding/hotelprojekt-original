  ...
  <div class="hero-content text-center text-white">
    <div class="container">
        ...
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
            ...
            <button type="button" class="btn btn-primary btn-lg fw-bolder px-4"><a href="zimmer.php" class="text-center text-white text-decoration-none">Zimmer buchen</a></button>
    ...
    <div class="container text-center d-flex justify-content-center align-items-center">
      ...
      <div class="container text-center p-2 rounded">
        <div class="row align-items-center mb-4">
          ...
          <div class="col-12 col-md-4">
            <div class="img-container rounded-3">
              <img src="assets/img/1.jpg" alt="hotel img" class="img-fluid">
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="img-container rounded-3">
              <img src="assets/img/2.jpg" alt="hotel img" class="img-fluid">
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="img-container rounded-3">
              <img src="assets/img/3.jpg" alt="hotel img" class="img-fluid">
            </div>
          </div>
        </div>
        <div class="row g-3 align-items-center ">
          <div class="col-12 col-md-4">
            <div class="img-container rounded-3">
              <img src="assets/img/4.jpg" alt="hotel img" class="img-fluid">
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="img-container rounded-3">
              <img src="assets/img/5.jpg" alt="hotel img" class="img-fluid">
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="img-container rounded-3">
              <img src="assets/img/6.jpg" alt="hotel img" class="img-fluid">
            </div>
          </div>
      </div>
    </div>
