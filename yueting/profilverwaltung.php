...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $kundendaten['anrede'] = $_POST['anrede'] ?? $kundendaten['anrede'];
    ...
    header('Location: logout.php');// nach erfolgreicher änderung der kundendaten, wird kunden weitergeleitet zur logoutseite
}
...
<div class="container">
    <h1 class="text-center my-5">Profilverwaltung</h1>
    <p class="text-center my-2">Hier können Sie Ihre Daten bearbeiten</p>
    <?php if($success): ?>
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" novalidate>
    ...
    <button href="kundendaten.php" class="btn btn-lg btn-success mt-5">Daten aktualisieren</button>
    </div>
    </form>
