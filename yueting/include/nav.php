<nav class="navbar navbar-expand-sm navbar-light bg-primary">
  <div class="container-fluid">
      ...
      <ul class="navbar-nav ms-auto me-4"> <!--ms-auto align items to the end-->
        ...
        <li class="nav-item">
          <a class="nav-link" href="zimmer.php"><h4>Zimmer</h4></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="include/blog.php"><h4>News</h4></a>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="dashboard.php" role="button" data-bs-toggle="dropdown"><h4>Login</h4></a>
